        ...
        <div className='flex flex-col p-4 justify-center max-w-7xl mx-auto mb-16 h-full'>
            ...
            <div className='flex justify-center items-center' data-aos='fade-up'>
                <form action="https://getform.io/f/a956fcc9-3aa4-476e-a3cc-60d257c73ab2" method="POST" className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='bg-slate-800 backdrop-blur-md bg-slate-800/60 text-slate-300 hover:bg-gradient-to-r from-cyan-500 to-blue-500 hover:text-white  hover:scale-105 duration-200 rounded-3xl mx-auto flex items-center p-4 m-5' >Submit</button>
                </form>
            </div>
        </div>
    </div>
