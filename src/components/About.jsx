...
const About = () => {
  return (
    <div name="about" className='w-full s md:h-screen max-h-fit bg-slate-900 pb-20 ' >
        <div className='max-w-7xl p-6  border rounded-lg shadow  bg-slate-800 border-slate-700 lg:mx-auto flex flex-col mx-5'>
            <div className='pb-8'>
