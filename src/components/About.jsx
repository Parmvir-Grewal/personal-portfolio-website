...
const About = () => {
  return (
    <div name="about" className='w-full h-screen bg-slate-900 ' >
        <div className='max-w-7xl p-6  border rounded-lg shadow  bg-slate-800 border-slate-700 mx-auto flex flex-col'>
            <div className='pb-8'>
